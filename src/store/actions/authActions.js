          ...
          <html>
            ...
            <body>
              <div class="message-container">
                <h1 style="color: #007bff;">Hello from RemoteCC!</h1>
                <div class="fontsize">
                  <p>This is a verification email from RemoteCC.</p>
      ...
      .then(data => {
        ...
        firebase
          ...
          .then(doc => {
            ...
            // Handle creating new bucket for the user
            // createNewBucket(uid)
...
export const existOrganization = (org_id, onSuccess) => async dispatch => {
  try {
    await firebase
      .firestore()
      .collection('organizations')
