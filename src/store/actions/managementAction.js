...
export const sendInvitation = (org_id, email, onSuccess) => async dispatch => {
  try {
    ...
    const info = {
      to: email,
      message: {
        subject: 'Invitation from RemoteCC!',
        html: `
          <html>
            <head>
              <style>
            ...
            <body>
              <div class="message-container">
                <h1 style="color: #007bff;">Invitation from RemoteCC!</h1>
                <div class="fontsize">
                  <p>This is a invitation code from Pixal Stream.</p>
                  <p>Your invitation code: <a href='https://remotecc-ccb45.web.app/invite/login/${token}'> Go to RemoteCC </a></p>
                </div>
              </div>
            </body>
          </html>
